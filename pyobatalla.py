...
class Menu:
    ...
    def __init__(self):
        ...
        b01 = Button(self.f3, text="Crear Usuario",  font=("Times", 12), foreground = "gray85", bg="gray30", command=lambda: ejecutar(mostrar(1)))
        b01.grid(column=0,row=0)
        b02 = Button(self.f3, text="Acceder al Usuario", font=("Times", 12), foreground = "gray85", bg="gray30", command=lambda: ejecutar(mostrar(2)))
