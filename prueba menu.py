...
b02=Button(v0, text='Acceder al Usuario', bg="SteelBlue", command=lambda: ejecutar(mostrar(2)))
b02.place(x=150,y=300)
b03=Button(v0, text='Cerrar', bg="red", command=lambda: ejecutar(ocultar(v0)))
